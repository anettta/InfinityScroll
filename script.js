...
// Unsplash API
let initialCountOfPhotosLoaded = 5;
...
function updateAPIURLWithNewCount(photoCount) {
  apiUrl = `https://api.unsplash.com/photos/random?client_id=${apiKey}&count=${photoCount}&query=${query}&orientation=${orientationStyle}`;
}
